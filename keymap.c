...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_HOME,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
           KC_LGUI,  KC_LCTRL,KC_LALT, KC_LOWER,  KC_ENT,            KC_SPC,  KC_RAISE, KC_RALT,  KC_RCTRL, KC_RGUI \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_F7,   KC_F8,   KC_F8,   KC_F9,   KC_F10,                  KC_F12, KC_INS,   KC_HOME, KC_PGUP,KC_DLINE, KC_BSPC, \
