...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,      KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     _______,KC_N,  KC_M,  KC_COMM,KC_DOT, KC_SLSH,KC_DEL,
                  KC_LGUI,  KC_LCTRL,KC_LALT,MO(_LOWER), KC_ENT,      KC_SPC,  LT(_RAISE, KC_DEL), KC_RALT,  KC_RCTRL, KC_RGUI
),
/*
 * QWERTY (gaming)
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_QWERTY_GAME] = LAYOUT(
  ...
  KC_LSFT,      KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     _______,KC_N,  KC_M,  KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,
                  KC_LGUI,  KC_LCTRL,KC_LALT,MO(_LOWER), KC_SPC,      KC_ENT,  LT(_RAISE, KC_DEL), KC_RALT,  KC_RCTRL, KC_ESC
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, KC_BTN2, KC_BTN3, KC_BTN1, KC_WH_D, _______,       _______, KC_UNDS, KC_MINS, _______, _______, _______, _______,
